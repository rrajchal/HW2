function openModal() {
    ...
    /* TODO Question 1.3: Starts here */
		...
		enableButton(letter, capital, number, length, match, passEqualsConfPass);
    }
}

function enableButton(letter, capital, number, length, match, passEqualsConfPass) {
    // TODO: Clear this function for students to implement    
    var button = document.getElementById('my_submit_button');
    var condition = (letter && capital && number && length && match && passEqualsConfPass); // TODO: Replace false with the correct condition
    if(condition) {       
